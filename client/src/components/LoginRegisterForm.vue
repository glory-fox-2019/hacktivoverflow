...
<div>
    ...
    <form v-on:submit.prevent="login">
      <div class="form-group">
        ...
        <input v-model="loginFormInput.email" type="email" class="form-control" id="email" required />
      </div>
      <div class="form-group">
        <label for="pwd">Password:</label>
        <input v-model="loginFormInput.password" type="password" class="form-control" id="pwd" required />
      </div>
      <center>
        <button
          type="submit"
    ...
    <button class="btn btn-warning btn-lg mt-3 mb-3" disabled>X overflow</button>
      <h4 class="text-center">Register Now</h4>
            <form v-on:submit.prevent="register">
                ...
                <center><button type="submit" class="btn btn-warning" style="background-color: #0f0e0ec5; color : rgb(255, 255, 255);" >register</button> </center>
                <hr>
                <hr>
                <center><span>Already have an account?</span></center>
                <center><span>Login <a href="#" @click="showRegisterForm(false)" >here</a> </span></center>
                <hr>     
            </form>
        </div>
        </div>
