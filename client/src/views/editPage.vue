        ...
        <div class = "card mb-4" style="background-color : rgba(218, 216, 216, 0.198)">
            <div class = "row">
                <div class = "col-sm mr-5 mb-5 ml-5 mt-5">
                    ...
                    <div class = "card mb-4">
                        <div class = "card-body">
                            <input type="submit" value = "Update Question" style="width : 100%; height: 40px; background-color:rgb(255, 116, 0); color:white" v-on:click = "editPost">
                        </div>
                    </div>
                </div>
            </div> 
...
export default {
    ...
    methods: {
        editPost () {
            this.$store.dispatch('editQuestion',{id:this.$route.params.id, data: {title: this.inputTitle, description: this.inputContent}})
            this.$router.push('/')
        }
    }
