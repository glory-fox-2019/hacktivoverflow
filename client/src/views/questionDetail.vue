    ...
    <b-modal title="Submit your question" id="modal-create" v-model="isAnswerModalActive">
      ...
      <b-form @submit.prevent="createAnswer" id="createAnswerForm">
        ...
        <b-form-group label="question" label-for="description">
           <textarea v-model="formCreateAnswer.description" placeholder="question" class="form-control" rows="3" ></textarea>
        </b-form-group>
      </b-form>
      <div slot="modal-footer">
        <b-button variant="primary" data-dismiss="modal" type="submit" form="createAnswerForm">Confirm</b-button>
      </div>
    </b-modal>
  </div>
</template>
